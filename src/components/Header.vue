                ...
                <div class="row align-items-center justify-content-between">
                    ...
                    <div class="col-5">
                        <div class="header-action">
                            ...
                            <button class="header-action-cart" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasWithCartSidebar" aria-controls="offcanvasWithCartSidebar">  {{cart}} Items
