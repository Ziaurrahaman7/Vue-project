                            ...
                            <div class="widget-item">
                                <div class="widget-about">
                                    <a class="widget-logo" href="index.html">
                                        <img src="https://htmldemo.net/merier/merier/assets/images/logo.png" alt="Logo" width="153" height="30">
                                    </a>
            ...
            <div class="footer-bottom">
                <div class="container pt-0 pb-0">
                    <div class="footer-bottom-content">
                        <a href="shop.html"><img src="https://htmldemo.net/merier/merier/assets/images/shop/payment.png" alt="Image-HasTech"></a>
