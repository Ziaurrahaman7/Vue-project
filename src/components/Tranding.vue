<template>
                ...
                <div class="container">
                    ...
                    <div class="row mb-n6">
                        <div  v-for="product in products.data" :key="product" class="col-sm-6 col-lg-4 mb-6">
                            <!--== Start Product Item ==-->
                            <div class="product-item product-item-border">
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="price">{{product.price}}<span class="price-old">{{product.discount}}</span></div>
